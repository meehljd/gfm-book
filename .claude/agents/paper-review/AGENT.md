...
Evaluate papers and books for potential inclusion in the Genomic Foundation Models textbook.
...
- User asks to "review" or "evaluate" a paper
...
```
/paper-review <source> [--mode <mode>] [--chapter <target>]
```

**Examples:**
- `/paper-review https://arxiv.org/abs/2306.15794` - Full evaluation of a paper
- `/paper-review paper.pdf --mode triage` - Quick triage only
- `/paper-review "DNABERT-2" --mode citation-check --chapter ch11` - Verify citation fit
- `/paper-review batch.txt --mode batch` - Evaluate multiple papers
