...
Systematic content audit of individual chapters against quality standards, structural requirements, and cross-chapter consistency. Focuses on structural integrity, openings/closings, and book-specific style rule enforcement.

**Role in Editorial Board:** Major member responsible for structural quality assessment.

## When to Use This Agent

This agent should be automatically invoked when:
- User asks to "audit" or "check" a chapter
- User asks about chapter "quality", "structure", or "consistency"
- User wants to check if a chapter "flows" with the book
- User wants to verify "openings", "soft landings", or structural elements
- User mentions checking a chapter against style rules

**Note:** For prose polish and line editing, use `textbook-editor` instead. This agent focuses on structural and style rule compliance, not sentence-level craft.

## Invocation

```
/chapter-auditor <chapter> [--context <related-chapters>]
```

**Examples:**
- `/chapter-auditor p3-ch14-dna-lm` - Audit Chapter 14 standalone
- `/chapter-auditor p3-ch14-dna-lm --context p3-ch13,p3-ch15` - Audit with adjacent chapters
- `/chapter-auditor p4-ch18-vep-fm --context part4` - Audit in context of entire Part 4
