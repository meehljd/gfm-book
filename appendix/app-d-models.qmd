...
|-------|-----------|---------|--------------|----------------|----------|
| *ESM-2* | 8M–15B | 1,024 AA | Transformer encoder | Structure, function, variants | @lin_language_2023 |
| *ESM-1v* | 650M | 1,024 AA | Transformer encoder | Zero-shot variant effects | @meier_esm-1v_2021 |
| *ESMFold* | 15B | 1,024 AA | Encoder + structure | Single-sequence folding | @lin_language_2023 |
| *ProtTrans* | 420M–3B | 1,024 AA | Transformer | Multilingual protein embeddings | @elnaggar_prottrans_2022 |
...
|-------|-------|--------|--------------|----------------|----------|
| *DeepSEA* | 1 kb | 919 chromatin features | CNN | Regulatory variant effects | @zhou_deep_2015 |
| *Beluga* | 2 kb | 2,002 features | CNN | Extended DeepSEA | @zhou_expecto_2018 |
| *Sei* | 4 kb | 21,907 targets | CNN | Sequence classes | @chen_sequence-based_2022 |
| *Basenji* | 131 kb | 4,229 tracks | Dilated CNN | Expression prediction | @kelley_basenji_2018 |
| *Basenji2* | 131 kb | 5,313 tracks | Dilated CNN | Cross-species, human + mouse | @kelley_cross-species_2020 |
...
| *PrimateAI-3D* | Missense | Deep learning + structure | Primate conservation | @sundaram_primateai_2018 |

### Protein Language Model–Based

| Model | Input | Method | Key Features | Citation |
|-------|-------|--------|--------------|----------|
| *AlphaMissense* | Missense | ESM + AlphaFold | Structure-aware PLM | @cheng_accurate_2023 |
| *ESM-1v* | Missense | Zero-shot PLM | No training required | @meier_esm-1v_2021 |
| *EVE* | Missense | VAE on MSA | Evolutionary model | @frazer_disease_2021 |
...
| *phyloP* | Any position | Phylogenetic model | Acceleration/conservation | @pollard_detection_2010 |
...
|-------|-------|--------|----------------|----------|
| *AlphaFold2* | Protein sequence + MSA | 3D structure | High-accuracy folding | @jumper_highly_2021 |
| *AlphaFold3* | Protein/DNA/RNA/ligand | Complex structure | Multi-molecule complexes | @abramson_accurate_2024 |
| *ESMFold* | Protein sequence | 3D structure | Single-sequence, fast | @lin_language_2023 |
...
| *GLUE* | Multi-omics | Integrated embeddings | Cross-modality integration | @cao_multi-omics_2022 |
