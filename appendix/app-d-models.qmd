...
| *Nucleotide Transformer* | 50M to 2.5B | 6 kb | 6-mer | Embeddings, regulatory prediction | @dalla-torre_nucleotide_2023 |
| *HyenaDNA* | 1.4M to 6.6M | 1 Mb | Single nucleotide | Long-range dependencies | @nguyen_hyenadna_2023 |
| *Caduceus* | 1.8M to 7.4M | 131 kb | Single nucleotide | Bidirectional, reverse complement | @schiff_caduceus_2024 |
| *GROVER* | 80M to 520M | 2 kb | Single nucleotide | DNA + RNA understanding | @sanabria_grover_2024 |
| *Evo* | 7B | 131 kb | Single nucleotide | Generation, whole-genome | @nguyen_sequence_2024 |
| *Evo 2* | 7B to 40B | 1 Mb | Single nucleotide | Multi-scale prediction | @brixi_evo_2025 |
...
|-------|-----------|---------|--------------|----------------|----------|
| *ESM-2* | 8M to 15B | 1,024 AA | Transformer encoder | Structure, function, variants | @lin_esm-2_2022 |
...
| *ProtTrans* | 420M to 3B | 1,024 AA | Transformer | Multilingual protein embeddings | @elnaggar_prottrans_2021 |
| *ProGen2* | 151M to 6.4B | 1,024 AA | Autoregressive | Protein generation | @nijkamp_progen2_2023 |
...
| *Pangolin* | [github.com/tkzeng/Pangolin](https://github.com/tkzeng/Pangolin) | N/A | MIT |
