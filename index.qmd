...
::: {#fig-book-structure}
![Visual roadmap of the book's seven parts showing progression and dependencies.](figs/intro/book-structure.svg)

Part I (Data Foundations) establishes the groundwork that feeds into Part II (Architectures) and Part III (Learning & Evaluation). These converge in Part IV (Foundation Model Families), the central hub surveying major model classes. Part V (Cellular Context) extends foundation models to systems biology, while Part VI (Responsible Deployment) develops evaluation and trust frameworks essential for Part VII (Applications & Frontiers). Cross-cutting themes of evaluation and interpretability run as vertical threads throughout.
:::
