...
**Prerequisites:** Part IV (foundation models) and Part VI (responsible deployment). Part I for data context.

| Chapter | Topic | Key Applications |
|---------|-------|-----------------|
| @sec-ch28-clinical-risk | Clinical Risk Prediction | Disease risk stratification, EHR integration, fairness |
| @sec-ch29-rare-disease | Rare Disease & Cancer | Variant prioritization, diagnostic pipelines, tumor analysis |
| @sec-ch30-drug-discovery | Drug Discovery | Target identification, genetic validation, biomarker development |
| @sec-ch31-design | Biological Design | Protein engineering, regulatory design, synthetic biology |
| @sec-ch32-frontiers | Frontiers | Emerging directions, open problems, future outlook |

**After completing Part VII, you will understand:**
...
Clinical risk prediction (@sec-ch28-clinical-risk) combines foundation model features with electronic health records to stratify patients for disease, progression, and treatment response. Variant interpretation in rare disease (@sec-ch29-rare-disease) enters diagnostic pipelines alongside clinical geneticists and laboratory scientists. Drug discovery applications (@sec-ch30-drug-discovery) contribute to target identification, genetic validation, and biomarker development. Reversing the direction of inference from prediction to generation (@sec-ch31-design), foundation models guide protein engineering, regulatory element design, and programmable biology. Emerging directions and open problems (@sec-ch32-frontiers) will shape how genomic AI moves from research to practice.
...
- **Integration challenges** where model outputs do not fit clinical workflows
- **Communication gaps** where predictions cannot be explained to stakeholders

Part VI provides the tools to anticipate and address these failure modes.
:::
...
- **Part IV** foundation model capabilities determine what predictions are possible
- **Part VI** evaluation and trust frameworks are prerequisites for responsible deployment
:::
