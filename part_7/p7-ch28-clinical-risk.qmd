...
The development of clinical prediction models follows an established methodology from Steyerberg's *Clinical Prediction Models* [@steyerberg_clinical_2019] that genomic foundation models must satisfy for clinical deployment:
