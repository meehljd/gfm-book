...
You learned about population frequency filtering earlier (@sec-ch30-frequency-filters). Now that you understand foundation model scoring, consider: Why must frequency filtering happen *before* FM scoring rather than after? What would happen if you scored all 25,000 variants with AlphaMissense and then filtered by frequency?
