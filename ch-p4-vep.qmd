...
- **Conservation and heuristic scores** (e.g., traditional tools like SIFT, PolyPhen, CADD), which combine evolutionary constraint and manually engineered features.
