# Sequence design and bioengineering with genomic foundation models
...
These themes connect directly to @sec-clinical-translation, @sec-drug-discovery, and @sec-responsible-genomics. Together, they suggest that the future of genomic design will depend not only on better models, but also on **careful integration with experimental design, rigorous evaluation, and robust norms for safe and equitable use**.