...
- **Clinical risk prediction** (@sec-ch28-clinical): Polygenic risk scores face equity challenges when derived from ancestry-biased training data, and clinical deployment requires navigating the SaMD framework
...
- **Drug discovery** (@sec-ch30-drug): Dual-use concerns intensify when generative models design novel therapeutic candidates that could theoretically be misused
...
- **Forward:** Regulatory principles recur in clinical risk (@sec-ch28-clinical), rare disease (@sec-ch29-rare-disease), drug discovery (@sec-ch30-drug), and sequence design (@sec-ch31-design); translation barriers in @sec-ch32-frontiers include regulatory bottlenecks
