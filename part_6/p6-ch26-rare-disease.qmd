...
* @jaganathan_spliceai_2019 — SpliceAI
* @avsec_enformer_2021 — Enformer
* @karczewski_mutational_2020 — gnomAD
* @tavtigian_modeling_2018 — ClinGen odds ratios
* @kong_rate_2012 — Germline mutation rate
* @tate_cosmic_2019 — COSMIC database
* @findlay_brca1_2018 — Saturation genome editing
* @brnich_recommendations_2019 — ClinGen functional evidence
* @lynch_egfr_2004 or @paez_egfr_2004 — EGFR/erlotinib
* @chapman_vemurafenib_2011 — BRAF/vemurafenib
* @andre_alpelisib_2019 — PIK3CA/alpelisib
* Global Genes or similar — 300 million affected
* OMIM/Orphanet — 7,000+ rare diseases
:::
