...
* @fda_aiml_devices_2024 — FDA AI/ML device count (opening hook)
* @abramoff_pivotal_2018 — First autonomous diagnostic AI (IDx-DR)
* @eu_mdr_2017 — EU MDR regulation
* @eu_ai_act_2024 — EU AI Act
* @fda_ldt_final_rule_2024 — FDA LDT oversight
* @sudlow_uk_biobank_2015 — UK Biobank
* @myriad_2013 — Supreme Court DNA patent case
* @imdrf_samd_2014 — SaMD framework definition
* @gymrek_identifying_2013 — Genomic re-identification risk
* @zhu_deep_leakage_2019 — Gradient leakage

Required Citations

Priority Legend
- **[REQUIRED]** - Specific factual claim requiring source
- **[RECOMMENDED]** - Would strengthen argument but not strictly necessary
- **[FRAMEWORK]** - Cites a framework, definition, or methodology

---

Opening (Lines 3-5)

| Line | Claim | Citation Key | Suggested Source |
|------|-------|--------------|------------------|
| 3 | "As of 2024, more than 500 AI-enabled medical devices have received FDA authorization" | **[REQUIRED]** `@fda_aiml_devices_2024` | FDA's official AI/ML-enabled medical devices list (updated quarterly) |
| 3 | "fewer than a dozen involve genomic interpretation" | **[REQUIRED]** `@fda_aiml_devices_2024` | Same source, filtered for genomic/genetic devices |

---

Regulatory Frameworks for Genomic AI (Lines 21-43)

| Line | Claim | Citation Key | Suggested Source |
|------|-------|--------------|------------------|
| 23 | IMDRF SaMD risk tier definitions | **[FRAMEWORK]** `@imdrf_samd_2014` | IMDRF "Software as a Medical Device": Possible Framework for Risk Categorization (2014) |
| 25 | Analytical validity, clinical validity, clinical utility framework | **[FRAMEWORK]** `@acce_framework_2004` or `@sachdeva_acce_2014` | CDC ACCE Model or ACMG standards |
| 27 | "the agency cleared the first autonomous diagnostic AI in 2018" | **[REQUIRED]** `@abramoff_pivotal_2018` | Abràmoff et al., "Pivotal trial of an autonomous AI-based diagnostic system for detection of diabetic retinopathy" (IDx-DR) |
| 27 | FDA locked vs. adaptive algorithm distinction | **[FRAMEWORK]** `@fda_aiml_framework_2021` | FDA "Artificial Intelligence/Machine Learning-Based Software as a Medical Device Action Plan" (2021) |
| 31 | "EU Medical Device Regulation (MDR), which fully replaced prior directives in 2021" | **[REQUIRED]** `@eu_mdr_2017` | Regulation (EU) 2017/745 |
| 31 | "The AI Act, which entered force in 2024" | **[REQUIRED]** `@eu_ai_act_2024` | Regulation (EU) 2024/1689 |
| 33 | IMDRF harmonization frameworks | **[FRAMEWORK]** `@imdrf_samd_convergence_2020` | IMDRF convergence documents |
| 35 | FDA intent to increase LDT oversight | **[REQUIRED]** `@fda_ldt_final_rule_2024` | FDA "Laboratory Developed Tests" Final Rule (2024) |

---

Data Governance and Consent (Lines 45-69)

| Line | Claim | Citation Key | Suggested Source |
|------|-------|--------------|------------------|
| 51 | GDPR genetic data as special category | **[FRAMEWORK]** `@gdpr_2016` | Regulation (EU) 2016/679, Article 9 |
| 51 | US Common Rule secondary research provisions | **[FRAMEWORK]** `@common_rule_2018` | 45 CFR 46 (revised 2018) |
| 51 | Genomic data resist complete deidentification | **[REQUIRED]** `@gymrek_identifying_2013` or `@erlich_identity_2014` | Gymrek et al. (2013) or Erlich & Narayanan (2014) on re-identification |
| 53 | Dynamic consent systems | **[FRAMEWORK]** `@kaye_dynamic_2015` | Kaye et al., "Dynamic consent: a patient interface for twenty-first century research networks" |
| 57 | UK Biobank governance and ~500,000 participants | **[REQUIRED]** `@sudlow_uk_biobank_2015` | Sudlow et al. (2015), UK Biobank resource description |
| 61 | Federated learning for genomics | **[RECOMMENDED]** `@rieke_federated_2020` | Rieke et al., "The future of digital health with federated learning" |
| 61 | Gradient updates can reveal individual information | **[REQUIRED]** `@zhu_deep_leakage_2019` | Zhu et al., "Deep Leakage from Gradients" |

---

Privacy and Genomic Data (Lines 71-94)

| Line | Claim | Citation Key | Suggested Source |
|------|-------|--------------|------------------|
| 93 | GINA prohibitions | **[FRAMEWORK]** `@gina_2008` | Genetic Information Nondiscrimination Act of 2008 |
| (implicit) | Membership inference attacks on genomic models | **[RECOMMENDED]** `@homer_membership_2008` | Homer et al. (2008), or more recent ML-specific attacks |

---

Intellectual Property (Lines 95-119)

| Line | Claim | Citation Key | Suggested Source |
|------|-------|--------------|------------------|
| 99 | "*Myriad* decision held that naturally occurring DNA sequences cannot be patented" | **[REQUIRED]** `@myriad_2013` | Association for Molecular Pathology v. Myriad Genetics, 569 U.S. 576 (2013) |
| 101 | AI inventorship legal questions | **[RECOMMENDED]** `@thaler_dabus_2021` | Thaler v. Vidal or related DABUS patent cases |

---

Responsible Development Practices (Lines 121-145)

| Line | Claim | Citation Key | Suggested Source |
|------|-------|--------------|------------------|
| 125 | Model cards framework | **[FRAMEWORK]** `@mitchell_model_cards_2019` | Mitchell et al., "Model Cards for Model Reporting" |
| 125 | Datasheets for datasets | **[FRAMEWORK]** `@gebru_datasheets_2021` | Gebru et al., "Datasheets for Datasets" |
| 133 | Training data bias inheritance in genomic models | **[RECOMMENDED]** `@martin_clinical_2019` | Martin et al., "Clinical use of current polygenic risk scores may exacerbate health disparities" |
| 145 | Automation bias | **[FRAMEWORK]** `@parasuraman_automation_bias_2010` | Parasuraman & Manzey, "Complacency and Bias in Human Use of Automation" |

---

Dual Use and Biosecurity (Lines 147-169)

| Line | Claim | Citation Key | Suggested Source |
|------|-------|--------------|------------------|
| 159 | Gap between computational generation and biological realization | **[RECOMMENDED]** `@soice_biosecurity_2023` | Soice et al., "Can large language models democratize access to dual-use biotechnology?" or similar biosecurity assessments |
| 161 | Staged deployment strategies | **[RECOMMENDED]** `@shevlane_model_release_2022` | Shevlane, "Structured access: an emerging paradigm for safe AI deployment" |

---

Open Technical Problems (Lines 171-201)

| Line | Claim | Citation Key | Suggested Source |
|------|-------|--------------|------------------|
| 175 | "largest foundation models in natural language processing now exceed a trillion parameters" | **[REQUIRED]** `@fedus_switch_2022` or `@chowdhery_palm_2022` | Switch Transformer or PaLM publications |
| 175 | "human genome spans 3 billion base pairs...20,000 protein-coding genes" | Textbook fact, no citation needed | — |
| 179 | State space models for sequences | **[RECOMMENDED]** `@gu_mamba_2023` | Gu & Dao, "Mamba: Linear-Time Sequence Modeling with Selective State Spaces" |
| 197 | Mendelian randomization | **[FRAMEWORK]** `@davey_smith_mr_2003` | Davey Smith & Ebrahim (2003) or more recent review |
:::


# Ethics and Frontiers {#sec-future}

The first genomic foundation model to receive U.S. Food and Drug Administration (FDA) clearance as a medical device will face a peculiar regulatory challenge: demonstrating that a system trained on millions of sequences from research biobanks, academic databases, and public repositories can safely inform clinical decisions for individual patients who never consented to such use. Clinical-grade variant interpretation tools already incorporate deep learning predictions, yet the regulatory frameworks governing their deployment were designed for deterministic software with traceable decision logic, not for neural networks whose internal representations resist simple explanation. As of 2024, more than 500 AI-enabled medical devices have received FDA authorization, but fewer than a dozen involve genomic interpretation, and none yet deploys a foundation model at scale. The gap between technical capability and regulatory readiness defines one of the central tensions facing the field.
...
Clinical validation connects model outputs to clinical outcomes. For a variant classifier, clinical validation might assess concordance with expert panel classifications, correlation with functional assay results, or agreement with segregation patterns in affected families. The choice of reference standard is itself contentious: ClinVar classifications, which many models use as training labels, reflect historical expert consensus that may lag behind accumulating evidence, and circular validation using the same database for training and evaluation produces misleadingly optimistic results (see @sec-confounding). The deployment realities discussed in @sec-clinical-risk and @sec-apx-compute illustrate how these validation requirements interact with institutional workflows, reimbursement constraints, and clinician trust; regulatory clearance represents only one barrier among many.
...
Ancestry bias manifests technically at every stage of the genomic AI pipeline. Polygenic scores derived from European-ancestry GWAS show 40 to 75 percent reductions in prediction accuracy for African-ancestry individuals (@sec-gwas). Variant effect predictors trained on ClinVar inherit that database's overrepresentation of European-ancestry variants, performing better for populations already well-served by genomic medicine (@sec-vep-fm). Models can exploit ancestry as a confounding shortcut, achieving high benchmark performance while systematically underperforming for underrepresented groups (@sec-confounding). Clinical risk models calibrated on single-institution data may provide inferior risk stratification to patients from populations or care settings not represented in development (@sec-clinical-risk). These are not independent problems but manifestations of a single structural issue: genomic datasets encode historical inequities in who gets sequenced, which populations are recruited into biobanks, and whose variants receive clinical characterization.

Technical solutions exist but require deliberate implementation. Ancestry-stratified evaluation mandates reporting performance separately for major population groups, not just aggregate metrics that obscure disparities. Calibration assessment by subgroup reveals when models systematically over- or under-estimate risk for specific populations. Uncertainty quantification can flag predictions for patients from underrepresented ancestries as less reliable, enabling appropriate clinical caution. Reweighting training data or applying group-wise calibration adjustments can partially mitigate disparities, though these post-hoc corrections cannot fully compensate for fundamental data gaps.

Yet technical fixes alone are insufficient. Addressing fairness in genomic AI ultimately requires expanding who participates in genomic research, which populations are prioritized for biobank recruitment, and how resources flow to sequencing initiatives in underrepresented communities. A model trained on biased data and corrected post-hoc will always underperform compared to a model trained on representative data. The field's trajectory depends on whether current disparities are treated as inconvenient technical limitations or as structural problems demanding structural solutions.
...
Current genomic foundation models largely operate on single modalities: DNA sequence, protein sequence, gene expression counts, chromatin accessibility signals. Biological reality is irreducibly multimodal, with information flowing across modalities through transcription, translation, signaling, and metabolism. The next generation of genomic foundation models will need to integrate across modalities more deeply.
