...
These themes connect directly to @sec-clinical-risk and @sec-drug-discovery, and @sec-future. Together, they suggest that the future of genomic design will depend not only on better models, but also on **careful integration with experimental design, rigorous evaluation, and robust norms for safe and equitable use**.