...
The discussion here builds on the benchmark construction principles in @sec-benchmarks and the methodological framework in @sec-evaluation. Where those chapters address how to measure performance, this chapter addresses why performance measurements can be misleading and what to do about it. The emphasis is on pitfalls: ways models can appear impressive while failing to capture the biology we care about.
