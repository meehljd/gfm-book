...
Positional encodings inject information about token positions into the model, a challenge first introduced in @sec-representations when discussing how models represent sequence information. The approach varies across methods, but the goal is consistent: break permutation invariance by making the model aware of where each token sits in the sequence.
