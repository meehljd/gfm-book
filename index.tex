...
enhancers for cognitive traits (\textbf{zhou\_sei\_2022?}).
...
\item
  ...
  analyses use 1000 Genomes SNPs) (\textbf{zhou\_sei\_2022?})
\end{itemize}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.4038}}
...
2015; J. Zhou et al. 2018; \textbf{zhou\_sei\_2022?}; Chen et al. 2022;
Ž. Avsec et al. 2021), newer models aim to:
...
\item
  ...
  \item
    ...
    Troyanskaya 2015; Ž. Avsec et al. 2021; \textbf{zhou\_sei\_2022?};
    Chen et al. 2022).
  \item
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.1875}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.1312}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.2312}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.1312}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.2312}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
