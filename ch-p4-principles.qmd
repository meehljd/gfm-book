...
# Genomic FMs: Principles & Practice
...
Building on DeepSEA, ExPecto, Sei, and Enformer [@zhou_deepsea_2015; @zhou_expecto_2018; @zhou_sei_2022; @chen_deepsea_2022; @avsec_enformer_2021], newer models aim to:
...
- **Delphi**, **MIFM**, and related models that couple GFMs with polygenic risk score (PRS) estimation for complex traits [@georgantas_delphi_2024; @rakowski_mifm_2025; @wu_genome-wide_2024].
...
- **Population diversity**
  ...
  - Early deep PRS models such as Delphi and MIFM explicitly tackle ancestry-aware evaluation [@georgantas_delphi_2024; @rakowski_mifm_2025; @wu_genome-wide_2024].
...
- **Multi-task sequence-to-function prediction**
  ...
  - Predict chromatin profiles, TF binding, accessibility, expression, etc., directly from sequence (DeepSEA, Enformer, Sei) [@zhou_deepsea_2015; @avsec_enformer_2021; @zhou_sei_2022; @chen_deepsea_2022].
...
- **Variant effect scoring**
  ...
  - Feed variant-level scores into downstream calibration layers or PRS models [@avsec_enformer_2021; @georgantas_delphi_2024; @rakowski_mifm_2025].
...
- **Trait-level prediction with large cohorts?**
  ...
  - Explore PRS pipelines that incorporate GFM-based variant priors such as Delphi or MIFM [@georgantas_delphi_2024; @rakowski_mifm_2025; @wu_genome-wide_2024].
