...
## RNA as Molecule Versus Transcriptome Readout {#sec-rna-perspectives}
...
## Why Secondary Structure Creates a Distinct Modeling Challenge {#sec-rna-structure-challenge}
...
### Flat Energy Landscape Problem {#sec-rna-energy-landscape}
...
### Base Pairing and Long-Range Dependencies {#sec-rna-base-pairing}
...
### Pseudoknots and Tertiary Complexity {#sec-rna-pseudoknots}
...
## Classical Approaches to Structure Prediction {#sec-rna-classical}
...
### Thermodynamic Folding Models {#sec-rna-thermodynamic}
...
### Comparative and Covariation Methods {#sec-rna-comparative}
...
## Deep Learning for Secondary Structure Prediction {#sec-rna-dl-structure}
...
### From Thermodynamics to Learned Patterns {#sec-rna-learned-patterns}
...
### Structure Probing as Supervision {#sec-rna-structure-probing}
...
## RNA Foundation Models {#sec-rna-foundation}
...
### Scale Gap with Protein Language Models {#sec-rna-scale-gap}
...
### Architectures and Objectives {#sec-rna-architectures}
...
### Downstream Applications {#sec-rna-downstream}
...
## Codon-Level Models for Coding RNA {#sec-rna-codon}
...
### Beyond Nucleotide Tokenization {#sec-rna-codon-tokenization}
...
### What Codon Models Add {#sec-rna-codon-advantages}
...
## UTR Models and Translation Regulation {#sec-rna-utr}
...
### Why UTRs Dominate Expression Control {#sec-rna-utr-control}
...
### Sequence-to-Expression Models {#sec-rna-expression-models}
...
### Integration with mRNA Design {#sec-rna-utr-design}
...
## mRNA Design and Optimization {#sec-rna-mrna-design}
...
### Design Objectives and Trade-offs {#sec-rna-design-objectives}
...
### Lessons from COVID-19 Vaccines {#sec-rna-covid-vaccines}
...
### Model-Based Design Strategies {#sec-rna-model-design}
...
## Noncoding RNA Classification and Function {#sec-rna-ncrna}
...
### Diversity of Noncoding RNA {#sec-rna-ncrna-diversity}
...
### From Handcrafted Features to Learned Representations {#sec-rna-ncrna-features}
...
## miRNA Target Prediction {#sec-rna-mirna}
...
## Splicing and Transcript Processing Models {#sec-rna-splicing}
...
### Beyond SpliceAI {#sec-rna-beyond-spliceai}
...
## Limitations and Open Challenges {#sec-rna-limitations}
...
### Sparse Structural Data {#sec-rna-sparse-data}
...
### Functional Annotation Gaps {#sec-rna-annotation-gaps}
...
### Maturity Gap {#sec-rna-maturity-gap}
