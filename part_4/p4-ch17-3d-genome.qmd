...
### Chromosome Territories and Compartments {#sec-territories-compartments}
...
### Topologically Associating Domains {#sec-tads}
...
### Loop Extrusion Mechanism {#sec-loop-extrusion}
...
### Fine-Scale Chromatin Loops {#sec-fine-scale-loops}
...
### Hi-C and Contact Matrices {#sec-hic-matrices}
...
### Resolution and Data Resources {#sec-3d-data-resources}
...
### Akita and Dilated Convolutions {#sec-akita}

Akita, introduced by Fudenberg et al. in 2020, established the paradigm for sequence-to-contact prediction [@fudenberg_predicting_2020]. The model takes approximately one megabase of DNA sequence as input and predicts Hi-C contact frequencies at 2 kilobase resolution. The architecture uses dilated convolutions to expand the receptive field without proportionally increasing parameters, enabling the model to integrate information across the full input window. The output is symmetric (contacts between positions i and j equal contacts between j and i), which the architecture enforces through appropriate pooling operations. Akita achieves correlation coefficients of 0.6 to 0.8 between predicted and observed contact maps in held-out genomic regions, successfully identifying TAD boundaries and major loop anchors.

### Orca and Multiscale Prediction {#sec-orca}
...
### Beyond One-Dimensional Models {#sec-beyond-1d}
...
### Structural Variant Interpretation {#sec-sv-interpretation}
...
### Causality and Permissive Architecture {#sec-3d-causality}
...
### Measurement Technologies {#sec-spatial-technologies}
