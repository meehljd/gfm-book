# Chapter 16 — Paper evaluation report (prose)
...
CpGPT: a Foundation Model for DNA Methylation — Camillo, Lucas Paulo de Lima and Sehgal, Raghav and Armstrong, Jenel and Higgins-Chen, Albert T. and Horvath, Steve and Wang, Bo — bioRxiv (2024) — DOI: 10.1101/2024.10.24.619766 — URL: https://www.biorxiv.org/content/10.1101/2024.10.24.619766v1
...
**Recommendation.** MONITOR. Suggested book location: Ch16 (genomic sequence modeling).
...
[GLUE] Multi-omics single-cell data integration and regulatory inference with graph-linked embedding — Cao, Zhi-Jie and Gao, Ge — Nature Biotechnology (2022) — DOI: 10.1038/s41587-022-01284-4 — URL: https://www.nature.com/articles/s41587-022-01284-4

**Scope fit.** This work is in-scope for the book: it applies deep learning to biological sequences (genomics), with direct relevance to genomic/protein foundation models or downstream tasks.

**Recency relevance.** This is recent/modern work (year 2022), aligned with current genomic foundation-model approaches.

**Venue signal.** The venue given in the BibTeX entry is Nature Biotechnology. This is generally a credible signal, but final confidence depends on confirming the version-of-record (especially if the entry is a preprint).
...
**Recommendation.** INCLUDE. Suggested book location: Ch16 (genomic sequence modeling).
...
scGPT: toward building a foundation model for single-cell multi-omics using generative AI — Cui, Haotian and Wang, Chloe and Maan, Hassaan and Pang, Kuan and Luo, Fengning and Duan, Nan and Wang, Bo — Nature Methods (2024) — DOI: 10.1038/s41592-024-02201-0 — URL: https://www.nature.com/articles/s41592-024-02201-0
...
### dixit_perturb-seq_2016

Missing reference for dixit_perturb-seq_2016
...
**Recommendation.** CITED. Suggested book location: Ch16.
...
### pearce_transcriptformer_2025

[TranscriptFormer] Cross-Species Generative Cell Atlas Across 1.5 Billion Years of Evolution: The TranscriptFormer Single-cell Model — Pearce, James D. and Simmonds, Sara E. and Mahmoudabadi, Gita and Krishnan, Lakshmi and Palla, Giovanni and Istrate, Ana-Maria and Tarashansky, Alexander and Nelson, Benjamin and Valenzuela, Omar and Li, Donghui and Quake, Stephen R. and Karaletsos, Theofanis — bioRxiv (2025) — DOI: 10.1101/2025.04.25.650731 — URL: https://www.biorxiv.org/content/10.1101/2025.04.25.650731v1
