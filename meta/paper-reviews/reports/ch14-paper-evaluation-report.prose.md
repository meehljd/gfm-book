# Chapter 14 — Paper evaluation report (prose)
...
A Gentle Introduction to Conformal Prediction and Distribution-Free Uncertainty Quantification — (2023)
...
**Recommendation.** CITED. Suggested book location: Ch14 (methods background).
...
AlphaGenome: AI for better understanding the genome — Avsec, Ziga and Latysheva, Natasha and Cheng, Jun — Google DeepMind (2025) — URL: https://deepmind.google/discover/blog/alphagenome-ai-for-better-understanding-the-genome/
...
**Venue signal.** The venue given in the BibTeX entry is Google DeepMind. This is generally a credible signal, but final confidence depends on confirming the version-of-record (especially if the entry is a preprint).
...
**Claim calibration.** Claims are likely at risk of overreach given the preprint/newness and typical benchmark fragility; treat as promising but unconfirmed until independent replication or a peer-reviewed version.
...
**PDF availability.** PDF/landing page via URL (verify access).

**Recommendation.** MONITOR. Suggested book location: Ch14 (genomic sequence modeling).
...
**Recommendation.** INCLUDE. Suggested book location: Ch14 (genomic sequence modeling).
...
GPN-MSA: an alignment-based DNA language model for genome-wide variant effect prediction — Benegas, Gonzalo and Albors, Carlos and Aw, Alan J. and Ye, Chengzhong and Song, Yun S. — bioRxiv (2024) — DOI: 10.1101/2023.10.10.561776 — URL: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10592768/

**Scope fit.** This work is in-scope for the book: it applies deep learning to biological sequences (genomics), with direct relevance to genomic/protein foundation models or downstream tasks.

**Recency relevance.** This is recent/modern work (year 2024), aligned with current genomic foundation-model approaches.

**Venue signal.** The venue given in the BibTeX entry is bioRxiv. This is generally a credible signal, but final confidence depends on confirming the version-of-record (especially if the entry is a preprint). Preprint/published-status check: Published version: Nature Biotechnology (2025).
...
A sequence-based global map of regulatory activity for human enhancer–gene interactions (SEI) — (2022)
...
[EVE] Disease variant prediction with deep generative models of evolutionary data — Frazer, Jonathan and Notin, Pascal and Dias, Mafalda and Gomez, Aidan and Min, Joseph K. and Brock, Kelly and Gal, Yarin and Marks, Debora S. — Nature (2021) — DOI: 10.1038/s41586-021-04043-8 — URL: https://www.nature.com/articles/s41586-021-04043-8
...
**Recency relevance.** This is a foundational paper (year 2017) that remains influential and is still commonly cited in modern foundation-model practice.
...
**Recommendation.** INCLUDE. Suggested book location: Ch14 (protein models/variant effects).
...
[popEVE] Proteome-wide model for human disease genetics — Orenbuch, Rose and Shearer, Courtney A. and Kollasch, Aaron W. and Spinner, Aviv D. and Hopf, Thomas and van Niekerk, Lood and Franceschi, Dinko and Dias, Mafalda and Frazer, Jonathan and Marks, Debora S. — Nature Genetics (2025) — DOI: 10.1038/s41588-025-02400-1 — URL: https://www.nature.com/articles/s41588-025-02400-1
...
### richards_standards_2015

Standards and guidelines for the interpretation of sequence variants (ACMG/AMP) — (2015)

**Scope fit.** This work is in-scope for the book: it applies deep learning to biological sequences (genomics), with direct relevance to genomic/protein foundation models or downstream tasks.

**Recency relevance.** This is a foundational paper (year 2015) that remains influential and is still commonly cited in modern foundation-model practice.
...
**Recommendation.** CITED. Suggested book location: Ch14 (genomic sequence modeling).
