# Chapter 09 — Paper evaluation report (prose)
...
**Recommendation.** INCLUDE. Suggested book location: Ch09 (genomic sequence modeling).
...
Placeholder: ben-david theory 2010 — (2010)
...
**Recency relevance.** This is a foundational paper (year 2010) that remains influential and is still commonly cited in modern foundation-model practice.
...
**Recommendation.** CITED. Suggested book location: Ch09.
...
Placeholder: brown language 2020 — (2020)
...
Nucleotide Transformer: building and evaluating robust foundation models for human genomics — Dalla-Torre, Hugo and Gonzalez, Liam and Mendoza-Revilla, Javier and Lopez Carranza, Nicolas and Grzywaczewski, Adam Henryk and Oteri, Francesco and Dallago, Christian and Trop, Evan and de Almeida, Bernardo P. and Sirelkhatim, Hassan and Richard, Guillaume and Skwark, Marcin and Beguir, Karim and Lopez, Marie and Pierrot, Thomas — Nature Methods (2023) — DOI: 10.1038/s41592-024-02523-z — URL: https://www.nature.com/articles/s41592-024-02523-z
...
Placeholder: finn model-agnostic 2017 — (2017)
...
Placeholder: gaedigk pharmacogene 2018 — (2018)
...
Placeholder: ganin domain-adversarial 2016 — (2016)

**Scope fit.** Scope fit is unclear from the BibTeX metadata alone; the title/venue do not unambiguously signal deep learning over genomic or protein sequences.

**Recency relevance.** This is a foundational paper (year 2016) that remains influential and is still commonly cited in modern foundation-model practice.
...
Placeholder: houlsby parameter-efficient 2019 — (2019)
...
Placeholder: howard universal 2018 — (2018)
...
**Recommendation.** CITED. Suggested book location: Ch09 (methods background).
...
Placeholder: jawahar what 2019 — (2019)
...
### kelley_cross-species_2020

Cross-species regulatory sequence activity prediction — Kelley, David R. — PLOS Computational Biology (2020) — DOI: 10.1371/journal.pcbi.1008050 — URL: https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1008050

**Scope fit.** This work is in-scope for the book: it applies deep learning to biological sequences (genomics), with direct relevance to genomic/protein foundation models or downstream tasks.

**Recency relevance.** This is mid-era work (year 2020) that often serves as a bridge between early deep learning for sequences and modern foundation models.

**Venue signal.** The venue given in the BibTeX entry is PLOS Computational Biology. This is generally a credible signal, but final confidence depends on confirming the version-of-record (especially if the entry is a preprint).
...
### kircher_general_2014

A general framework for estimating the relative pathogenicity of human genetic variants — Kircher, Martin and Witten, Daniela M. and Jain, Preti and O'Roak, Brian J. and Cooper, Gregory M. and Shendure, Jay — Nature Genetics (2014) — DOI: 10.1038/ng.2892

**Scope fit.** This work is in-scope for the book: it applies deep learning to biological sequences (genomics), with direct relevance to genomic/protein foundation models or downstream tasks.

**Recency relevance.** This is a foundational paper (year 2014) that remains influential and is still commonly cited in modern foundation-model practice.
...
### lee_pre-training_2020

Placeholder: lee pre-training 2020 — (2020)
...
Placeholder: li prefix-tuning 2021 — (2021)
...
Placeholder: mccloskey catastrophic 1989 — (1989)

**Scope fit.** Scope fit is unclear from the BibTeX metadata alone; the title/venue do not unambiguously signal deep learning over genomic or protein sequences.

**Recency relevance.** This is a foundational paper (year 1989) that remains influential and is still commonly cited in modern foundation-model practice.
...
Placeholder: rieke future 2020 — (2020)
...
Placeholder: rives biological 2021 — (2021)
...
Placeholder: snell prototypical 2017 — (2017)
...
### wang_characterizing_2019

Placeholder: wang characterizing 2019 — (2019)
...
Placeholder: wang tent 2021 — (2021)
...
Placeholder: zaken bitfit 2022 — (2022)
...
**Recommendation.** MONITOR. Suggested book location: Ch09 (genomic sequence modeling).
