# Chapter 13 — Paper evaluation report (prose)
...
**Recommendation.** MONITOR. Suggested book location: Ch13 (genomic sequence modeling).
...
**Recommendation.** INCLUDE. Suggested book location: Ch13 (genomic sequence modeling).
...
**Tier 1 red flags.** Major issue: this is a placeholder citation (citekey not found). We cannot evaluate methodological rigor without the real paper/PDF and correct metadata.
...
**PDF availability.** PDF unknown due to placeholder entry.

**Recommendation.** CITED. Suggested book location: Ch13.


---

### gasperini_genome-wide_2019

A genome-wide framework for mapping gene regulation via cellular genetic screens — (2019)
...
[Basenji2] Sequential regulatory activity prediction across chromosomes with convolutional neural networks — Kelley, David R. and Reshef, Yakir A. and Bileschi, Maxwell and Belanger, David and McLean, Cory Y. and Snoek, Jasper — Genome Research (2018) — DOI: 10.1101/gr.227819.117 — URL: http://genome.cshlp.org/content/28/5/739
...
**Venue signal.** The venue given in the BibTeX entry is Genome Research. This is generally a credible signal, but final confidence depends on confirming the version-of-record (especially if the entry is a preprint).
