...
In single-cell analysis, *scGPT* embeddings combined with cell-cell communication graphs enable more accurate prediction of perturbation effects than either component alone [@cui_scgpt_2023; @segceco_singlecell_2024; @cgcom_communication_2023]. The cell embeddings capture transcriptional state, while the graph structure encodes spatial and molecular interaction context.
