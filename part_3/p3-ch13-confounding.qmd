...
The terminology and conceptual framework for understanding heterogeneity in genetic associations derives from classical statistical genetics, including Laird and Lange's *Fundamentals of Modern Statistical Genetics* [@laird_fundamentals_2011] and Gordon's *Heterogeneity in Statistical Genetics* [@gordon_heterogeneity_2020]. Three forms of heterogeneity documented in genetics can complicate foundation model evaluation:
...
::: {.callout-note title="Matching Methods in Genomic Case-Control Studies"}
...
::: {.callout-tip title="Propensity Scores vs. Prognostic Scores"}
