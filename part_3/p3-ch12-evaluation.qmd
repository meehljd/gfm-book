...
The evaluation frameworks in this chapter draw from Steyerberg's *Clinical Prediction Models* framework [@steyerberg_clinical_2019], which distinguishes three core performance dimensions:
...
The clinical prediction literature establishes rigorous standards for calibration assessment [@steyerberg_clinical_2019]. Beyond reliability diagrams and ECE, calibration can be characterized as:
...
- [ ] Has dataset diversity been quantified to ensure evaluation sets are not redundant? (See the "Measuring Dataset Diversity" callout in @sec-ch13-benchmark-design for formal diversity metrics.)
