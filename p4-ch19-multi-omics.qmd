# Multi-Omics & Systems Biology  {#sec-multi-omics}
...
Single-cell and epigenomic foundation models from @sec-single-cell bring methylation, cellular identity, and 3D genome structure into the picture. CpGPT treats methylation as a foundation modeling problem. scGPT and Geneformer learn cellular representations from massive transcriptomic corpora. GLUE enables integration across modalities measured in different cells.
