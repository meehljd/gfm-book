...
- **Strong critique of “attention as explanation” + alternatives**  
  They clearly articulate why **raw attention maps are not inherently interpretable** (layer mixing, values being ignored, head averaging problems) and point to better options:
  - Attention rollout and attention flow,  
  - Layer-wise relevance propagation (classic & transformer-adapted),  
  - SHAP / weightedSHAP. :contentReference[oaicite:9]{index=9}  
  You can lean on this review for a short “Why we should stop publishing raw attention heatmaps as ‘interpretations’” box in p5-ch19-interp.
