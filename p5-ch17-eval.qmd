...
Genomic foundation models (@sec-princ) complicate evaluation because there are multiple ways to use them, each testing different aspects of the learned representations. The appropriate evaluation regime depends on the downstream application and available resources.
