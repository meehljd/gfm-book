...
- **Part III** foundation models are evaluated against the benchmarks derived from @sec-ch02-data resources
- **Part V** (@sec-ch11-benchmarks, @sec-ch12-confounding) examines how biases introduced here propagate through evaluation
- **Part VI** clinical applications must navigate the ancestry and ascertainment biases documented in @sec-ch03-gwas
:::
