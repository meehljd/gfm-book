...
## Reference Genomes and Gene Annotations {#sec-data-reference}
...
### Reference Assemblies {#sec-data-reference-assemblies}
...
### Gene Models {#sec-data-gene-models}
...
## Population Variant Catalogs and Allele Frequencies {#sec-data-population}
...
### dbSNP and Variant Identifiers {#sec-data-dbsnp}
...
### 1000 Genomes and Early Reference Panels {#sec-data-1000genomes}
...
### Genome Aggregation Database (gnomAD) {#sec-data-gnomad}
...
## Biobanks and GWAS Data {#sec-data-biobanks}
...
### Large Population Cohorts {#sec-data-cohorts}
...
### GWAS Summary Statistics {#sec-data-gwas-summary}
...
## Functional Genomics and Regulatory Landscapes {#sec-data-functional}
...
### ENCODE, Roadmap, and Related Consortia {#sec-data-encode}
...
### Cistrome Data Browser {#sec-data-cistrome}
...
### From Assays to Training Labels {#sec-data-assays-labels}
...
### Deep Mutational Scanning and Multiplexed Variant Assays {#sec-data-dms}
...
## Expression and eQTL Resources {#sec-data-expression}
...
### Bulk Expression Atlases {#sec-data-gtex}
...
### Single-Cell and Context-Specific Expression {#sec-data-single-cell}
...
## Phenotype Definition and Data Quality {#sec-data-phenotypes}
...
### Problem of Binary Disease Definitions {#sec-data-binary-phenotypes}
...
### Electronic Health Record Quality and Completeness {#sec-data-ehr}
...
### Coding Inconsistencies and Label Noise {#sec-data-label-noise}
...
### Deep Phenotyping Approaches {#sec-data-deep-phenotyping}
...
### Impact on Downstream Modeling {#sec-data-phenotype-impact}
...
## Variant Interpretation Databases and Clinical Labels {#sec-data-clinical}
...
### ClinVar and Clinical Assertions {#sec-data-clinvar}
...
### Complementary Clinical Databases {#sec-data-clinical-other}
...
### ClinGen and Expert Curation {#sec-data-clingen}
...
### Pharmacogenomics Resources {#sec-data-pharmacogenomics}
...
## Inherited Constraints {#sec-data-constraints}
