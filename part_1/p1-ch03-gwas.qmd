...
The phenotype quality challenges described here recur in multi-omic integration (@sec-ch23-clinical-integration) and clinical deployment of risk models (@sec-ch12-evaluation). Systematic approaches to phenotype quality assessment connect to label quality discussions in @sec-ch13-label-bias.
